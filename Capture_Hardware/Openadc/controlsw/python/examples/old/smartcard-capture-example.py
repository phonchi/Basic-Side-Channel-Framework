...
class SASEBO():   
    ...
    def loadEncryptionKey(self, key):
        ...
        apdu = [0x80, 0x02, 0x00, 0x00, 0x10, 0x2b ,0x7e ,0x15 ,0x16 ,0x28 ,0xae ,0xd2 ,0xa6 ,0xab ,0xf7 ,0x15 ,0x88 ,0x09 ,0xcf ,0x4f ,0x3c, 0x10];        
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.statusBar()
        self.setWindowTitle("Smartcard / OpenADC Capture App")
        self.title = QLabel("Smartcard / OpenADC Capture App")
